            ...
            <tr>
              ...
              <td class="text-end">
                <div class="btn-group btn-group-sm">
                  ...
                  <a class="btn btn-outline-info" href="/products/<?= htmlspecialchars(!empty($p['parent_product_id']) ? ($p['parent_slug'] ?? 'product-' . $p['parent_product_id']) : ($p['slug'] ?? 'product-' . $p['id'])) ?>" target="_blank" title="View">
                    <i class="bi bi-eye"></i>
                  </a>
