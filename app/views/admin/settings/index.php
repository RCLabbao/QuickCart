...
<div class="tab-pane fade <?= $activeTab==='shipping'?'show active':'' ?>" id="tab-shipping" role="tabpanel">
  <!-- Unified Shipping Settings Form -->
  <form method="post" action="/admin/settings" id="shippingSettingsForm">
    <?= csrf_field() ?>
    ...
    <!-- Save Button for All Shipping Settings -->
    <div class="card border-0 shadow-sm">
      <div class="card-body">
        <button type="submit" class="btn btn-primary btn-lg">
          <i class="bi bi-save me-2"></i>Save All Shipping Settings
        </button>
        <small class="text-muted ms-3">All delivery methods, fees, and city restrictions will be saved together.</small>
      </div>
    </div>
  </form>
