...
-- NOTE: Run this in phpMyAdmin after selecting your database.
-- This script creates ONLY the tables (no sample data). It is MySQL 5.7+/MariaDB compatible.
...
-- NOTE: Extra CREATE INDEX ... IF NOT EXISTS statements from the original schema
-- are intentionally omitted for compatibility with MySQL 5.7/MariaDB.
